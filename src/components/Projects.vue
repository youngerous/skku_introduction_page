  ...
  data(){
    return{
      projects:[
        ...
        {
          name: '스클럽(SKKLUB)',
          text: '성균관대학교에 있는 동아리, 학회, 소모임의 집합체! <br>입학해서 뭘 할지 모르는 신입생들, 복학해서 새로운 친구 사귀고 싶은 복학생들 모두 여기 참고하세요!',
          creator: '이동엽, 정유진, 황희조',
        ...
        {
          name: '성균공약모음',
          text: '성균관대학교의 2014년부터 2017년까지의 총학생회, 단과대 학생회가 어떤 공약을 내걸었는지, 얼마나 시행했는지를 확인할 수 있습니다.<br>(성대신문 기사 내용을 바탕으로 선정)', 
